...
HD_PWD='C:/Users/cao2/storm_soc_everything/storm_soc_everything.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log STORM_SoC_basic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source STORM_SoC_basic.tcl
