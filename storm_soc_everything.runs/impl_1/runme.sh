...
HD_PWD='C:/Users/cao2/storm_soc_everything/storm_soc_everything.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log STORM_SoC_basic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source STORM_SoC_basic.tcl -notrace
